...
<body>
    <div class="container">
        ...
        <a href="Bindex.php">Home</a>
            <a href="Bcreate_content.php">Create Content</a>
            <a href="Bcreators_hub.php">Creators Hub</a>
            <a href="Notifications.php">Notifications</a>
            <a href="stock.php">Create Investment Offer</a>
            <a href="market.php">Live Market</a>
            <a href="Blibrary.php">Library</a>
            <a href="Bprofile.php">Profile</a>
            <a href="investment_options.php">Update Investment Options</a>
            <a href="Brequests.php">Investment Requests</a>
