    ...
    <div class="container">
        <?php if (isset($_SESSION['username'])): ?>
            ...
            <nav>
                ...
                <a href="investors.php" class="nav-item">Investors</a>
                <a href="create_content.php" class="nav-item">Create Content</a>
                <a href="creators_hub.php" class="nav-item">Creators Hub</a>
