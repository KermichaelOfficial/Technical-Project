...
$sql = "SELECT * FROM admin_investments WHERE company_type = 'Technology' ORDER BY id DESC"; 
...
<h1>Technology Investment Opportunities</h1>
...
<?php if ($result->num_rows > 0): ?>
    ...
    <?php endwhile; ?>
<?php else: ?>
    <p style="text-align:center;">No Technology investments available. Please check back later.</p>
<?php endif; ?>
