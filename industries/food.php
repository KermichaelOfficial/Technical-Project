...
$sql = "SELECT * FROM admin_investments WHERE company_type = 'Food & Beverage' ORDER BY id DESC"; 
...
<?php if ($result->num_rows > 0): ?>
    ...
    <?php endwhile; ?>
<?php else: ?>
    <p style="text-align:center;">No Food & Beverage investments available. Please check back later.</p>
<?php endif; ?>
