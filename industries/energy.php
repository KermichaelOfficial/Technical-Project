...
$sql = "SELECT * FROM admin_investments WHERE company_type = 'Energy' ORDER BY id DESC"; 
...
<head>
    ...
    <title>Energy Investment Display</title>
...
<h1>Energy Investment Opportunities</h1>
...
<?php if ($result->num_rows > 0): ?>
    ...
    <?php endwhile; ?>
<?php else: ?>
    <p style="text-align:center;">No Energy investments available. Please check back later.</p>
<?php endif; ?>
