...
$sql = "SELECT * FROM admin_investments WHERE company_type = 'Real Estate/Construction' ORDER BY id DESC"; 
...
<h1>Real Estate/Construction Investment Opportunities</h1>
...
<?php if ($result->num_rows > 0): ?>
    ...
    <?php endwhile; ?>
<?php else: ?>
    <p style="text-align:center;">No Real Estate/Construction investments available. Please check back later.</p>
<?php endif; ?>
