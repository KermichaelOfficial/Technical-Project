...
$sql = "SELECT * FROM admin_investments WHERE company_type = 'Cannabis' ORDER BY id DESC"; 
...
<h1>Cannabis Investment Opportunities</h1>
...
<?php if ($result->num_rows > 0): ?>
    ...
    <?php endwhile; ?>
<?php else: ?>
    <p style="text-align:center;">No Cannabis investments available. Please check back later.</p>
<?php endif; ?>
