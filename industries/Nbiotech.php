...
$sql = "SELECT * FROM admin_investments WHERE company_type = 'Biotech' ORDER BY id DESC"; 
...
<?php if ($result->num_rows > 0): ?>
    ...
    <?php endwhile; ?>
<?php else: ?>
    <p style="text-align:center;">No Biotech investments available. Please check back later.</p>
<?php endif; ?>
