...
$sql = "SELECT * FROM admin_investments WHERE company_type = 'Software' ORDER BY id DESC";
...
<h1>Software Investment Opportunities</h1>
...
<?php if ($result->num_rows > 0): ?>
    ...
    <?php endwhile; ?>
<?php else: ?>
    <p style="text-align:center;">No Software investments available. Please check back later.</p>
<?php endif; ?>
