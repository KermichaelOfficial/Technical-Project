...
$sql = "SELECT * FROM admin_investments WHERE company_type = 'Aerospace & Defense' ORDER BY id DESC"; 
...
<h1>Aerospace & Defense Investment Opportunities</h1>
...
<?php if ($result->num_rows > 0): ?>
    ...
    <?php endwhile; ?>
<?php else: ?>
    <p style="text-align:center;">No Aerospace & Defense investments available. Please check back later.</p>
<?php endif; ?>
